...
ALTER TABLE ONLY "public"."customer_contractors"
    ADD CONSTRAINT "customer_contractors_contractor_fk" FOREIGN KEY ("contractor_company_id") REFERENCES "public"."contractor_companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."customer_contractors"
    ADD CONSTRAINT "customer_contractors_customer_fk" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE CASCADE;
